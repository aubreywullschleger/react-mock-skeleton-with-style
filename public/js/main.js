...
var ListItemX = React.createClass({
  displayName: "ListItemX",

  render: function () {
    return React.createElement(
      "div",
      { className: "col-xs-8 col-md-4 col-lg-4" },
      React.createElement(
        "div",
...
var ListX = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { className: 'row' },
      React.createElement(ListItemX, { dataNum: '20', dataDescription: 'new penquins added this month', key: '20' }),
      React.createElement(ListItemX, { dataNum: '$1250', dataDescription: 'monthly average spent on candles', key: '1250' }),
      React.createElement(ListItemX, { dataNum: '$50000000000', dataDescription: 'yearly income goal', key: '500000000000' }),
      React.createElement(ListItemX, { dataNum: '15080', dataDescription: 'otters seen', key: '15080' }),
      React.createElement(ListItemX, { dataNum: '12000', dataDescription: 'WoW quests finished', key: '12000' }),
      React.createElement(ListItemX, { dataNum: '5100', dataDescription: 'puppies', key: '5100' })
    );
  }
});
...
},{"./ListItemX.jsx":159,"react":158}],161:[function(require,module,exports){
var React = require('react');
var ListX = require('./ListX.jsx');

var PanelListXManager = React.createClass({
  displayName: 'PanelListXManager',

  render: function () {
    return React.createElement(
      'ul',
      null,
      React.createElement(ListX, null)
    );
  }
});
...
},{"./ListX.jsx":160,"react":158}],162:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom');
var PanelListXManager = require('./components/PanelListXManager.jsx');

ReactDOM.render(React.createElement(PanelListXManager, null), document.getElementById('container'));

},{"./components/PanelListXManager.jsx":161,"react":158,"react-dom":2}]},{},[162]);
